...
namespace API.FlySic.Infrastructure.Migrations
{
    ...
    [Migration("20250819013022_newFieldAcceptedUserTableFlightForm")]
    partial class newFieldAcceptedUserTableFlightForm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.FlySic.Domain.Entities.FlightRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("API.FlySic.Domain.Entities.FlightForm", b =>
                {
                    b.HasOne("API.FlySic.Domain.Entities.User", "AcceptedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("API.FlySic.Domain.Entities.FlightRating", b =>
                {
                    b.HasOne("API.FlySic.Domain.Entities.User", "Evaluated")
                        .WithMany()
                        .HasForeignKey("EvaluatedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.FlySic.Domain.Entities.User", "Evaluator")
                        .WithMany()
